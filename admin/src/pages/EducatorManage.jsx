...
import { Search, Trash2, Loader2, Presentation } from "lucide-react";
    ...
    <div className="p-6 md:p-10 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-white/60 font-semibold">View and manage all registered educator accounts.</p>
        </div>
        ...
        <form onSubmit={handleSearch} className="relative w-full md:w-96">
          ...
          <input
            type="text"
            placeholder="Search by name, email, educator ID..."
            value={search}
